 ...
 * System.out.prinln(); 을 사용하여 로그를 확인할 수 있으나 이보다는 로그를 기록하는 방법을 사용한다.
 * log4j은 다음과 같은 레벨은 같다.
 ...
 * WARNING : 소프트웨어가 동작하고 있지만, 예상지 못한 일이 발생하고 가까운 미래에 문제가 발생할 수 있다는 경고이다.
 * 			 에로 디스크 공간 부족 -> 프로그램은 동작되지만 앞으로 문제가 발생할 수도 있음
